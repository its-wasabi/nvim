...
-- 0 = no cache, 1 = only remote, 2 = cache everything
vim.g.netrw_fastbrowse = 0;
-- Which files to hide while browsing
-- 0 = show all,1 = show not-hidden files, 2 = show hidden files only
vim.g.netrw_hide = 0;
